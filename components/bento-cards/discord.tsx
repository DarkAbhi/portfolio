...
const DiscordCard = () => {
  ...
  return (
    <motion.a
      ...
      className="block col-span-1 md:col-span-1 md:row-span-1 bg-[#151515] relative w-full h-full overflow-hidden rounded-2xl py-4 md:py-0"
    ...
    >
      ...
      <div className="relative w-full h-full flex items-center justify-center">
        <Image src="/discord.png" alt="Discord icon" width={100} height={100} />
      </div>
    </motion.a>
  );
};
