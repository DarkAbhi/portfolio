...
export default function AboutMeCard() {
  ...
  const handleMouseMove = (e: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
    ...
    rotateX.set(((y - centerY) / centerY) * -10); // Increased multiplier for more pronounced tilt
    rotateY.set(((x - centerX) / centerX) * 10); // Increased multiplier for more pronounced tilt
  };
  ...
  return (
    <motion.div
      className="col-span-2 md:col-span-3 row-span-1 bg-[#151515] rounded-2xl p-4 flex items-center gap-4"
    ...
    >
      ...
      />
      <div>
        <h2 className="text-xl font-bold text-white mb-2">Abhishek AN</h2>
        <p className="text-sm text-gray-400">
          Passionate about technology and climate action. I strive to create
          innovative solutions that make a positive impact on both people and
          the planet.
        </p>
      </div>
    </motion.div>
